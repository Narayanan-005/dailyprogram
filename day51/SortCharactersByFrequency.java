...
public class SortCharactersByFrequency {
    public static void main(String[] args) {
        System.out.println(sortCharactersByFrequency1("cccaaa"));
        System.out.println(sortCharactersByFrequency2("cccaaa"));
        System.out.println(sortCharactersByFrequency3("cccaaa"));
    }
